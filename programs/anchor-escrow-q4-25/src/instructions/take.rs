...
impl<'info> Take<'info> {
    pub fn deposit(&mut self) -> Result<()> {
        let tranfer_accounts: TransferChecked = TransferChecked {
        ...
        let cpi_ctx: CpiContext<TransferChecked> = CpiContext::new(self.token_program.to_account_info(), tranfer_accounts);
